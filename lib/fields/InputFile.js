...
export class InputFile extends React.PureComponent {
    ...
    render() {
        ...
        return React.createElement("input", { id: this.props.id, name: this.props.name, type: "file", className: "form-control" +
                ...
                (disabled ? " disabled" : ""), style: this.props.style, disabled: disabled, "aria-disabled": disabled, title: this.props.label, "aria-label": this.props.label, onChange: this.handleChange });
    }
}
// name
