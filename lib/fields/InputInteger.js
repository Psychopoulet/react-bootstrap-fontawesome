...
export class InputIntegerLabel extends React.PureComponent {
    ...
    render() {
        ...
        return React.createElement("div", { className: "mb-3" +
            ...
            !integerValid ? React.createElement(InvalidFeedBackInteger, null) : null,
            integerValid && !minValid ? React.createElement(InvalidFeedBackMin, { min: this.props.min, current: this.props.value }) : null,
            integerValid && !maxValid ? React.createElement(InvalidFeedBackMax, { max: this.props.max, current: this.props.value }) : null);
    }
}
// name
