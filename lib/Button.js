...
class Button extends React.PureComponent {
    ...
    render() {
        ...
        return React.createElement("button", { id: this.props.id, role: "button", type: this.props.type ? this.props.type : "button", className: className, style: this.props.style, disabled: disabled, "aria-disabled": disabled, title: this.props.title, "aria-label": this.props.title, onClick: this.handleClick },
            this.props.icon ? React.createElement(Icon, { type: this.props.icon, child: true }) : null,
            this.props.icon && this.props.children ? React.createElement(React.Fragment, null, "\u00A0") : null,
            this.props.children);
    }
}
// name
