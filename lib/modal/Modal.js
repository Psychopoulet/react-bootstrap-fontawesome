    ...
    _renderContent() {
        ...
        return React.createElement("div", { className: className, style: this.props.style },
            React.createElement("div", { className: "modal-content" +
                ...
                this.props.title || "function" === typeof this.props.onClose ? React.createElement("div", { className: "modal-header" +
                        (this.props.variant ? " border-" + this.props.variant : "") },
                    this.props.title ? React.createElement("h5", { className: "modal-title" }, this.props.title) : null,
