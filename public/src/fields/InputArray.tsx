...
export class InputArray extends React.Component<iPropsInputArray, iStateInputArray> {
    ...
    public componentDidUpdate (prevProps: iPropsInputArray): void {
    ...
    private readonly _handleAddLineWithEnter = (e: React.KeyboardEvent<HTMLInputElement | HTMLTextAreaElement>): void => {

        if ("Enter" === e.key) {
            this._handleAddLine(e as React.KeyboardEvent<HTMLInputElement>);
        }

    };

    private readonly _handleAddLine = (e: React.MouseEvent<HTMLButtonElement> | React.KeyboardEvent<HTMLInputElement>): void => {
...
export class InputArrayLabel extends React.PureComponent<iPropsInputArrayLabel> {
    ...
    // name
        ...
        public static displayName: string = "InputArrayLabel";
