...
export class InvalidFeedBack extends React.PureComponent<iPropsInvalidFeedBack> {
    ...
    public render (): React.JSX.Element {
        ...
        return <small id={ this.props.id } className={ "form-text text-danger" + ("string" === typeof this.props.className ? " " + this.props.className : "") } style={ this.props.style }>
            { this.props.alert }
        </small>;
...
export class InvalidFeedBackRequired extends React.PureComponent<iPropsNode> {
    ...
    public render (): React.JSX.Element {
        ...
        return <InvalidFeedBack id={ this.props.id } className={ "form-text text-danger" + ("string" === typeof this.props.className ? " " + this.props.className : "") } style={ this.props.style } alert={
            "Content required"
        } />;
